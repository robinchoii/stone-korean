<template>
    <div class='cold-noodle food-wrapper'>

        <div class='cold-noodle-header main-header'>

            <h2>Cold Noodles</h2>

            <div class='cold-noodle-about main-about'>
        ...
        <div class='cold-noodle-items food-items-grid'>
