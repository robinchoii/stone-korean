<template>
    <div>
        <h1 style='text-align:center;'>Where to?</h1>
        <div class='online-order-container'>
            <button v-show='isLocation' class='order-card' @click='toggleRedmondLocation()'>
                <h1 style='color:#e2e2e2'>Redmond</h1>
            </button>
